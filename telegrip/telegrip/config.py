...
DEFAULT_CONFIG = {
    ...
    "control": {
        ...
        # When True, Telegrip will automatically compensate wrist flex so the
        # end-effector pitch stays constant while translating (unless the user
        # intentionally changes pitch via controller rotation).
        "keep_gripper_level": True,
    },
    "paths": {
...
# Control behavior
KEEP_GRIPPER_LEVEL = _config_data.get("control", {}).get("keep_gripper_level", True)
...
class TelegripConfig:
    ...
    # Control behavior
    keep_gripper_level: bool = KEEP_GRIPPER_LEVEL
